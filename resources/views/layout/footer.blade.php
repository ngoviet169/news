                    ...
                    <div class="footer_widget">
                        ...
                        <ul class="ppost_nav wow fadeInLeftBig">
                            ...
                            <li>
                                <div class="media"><a href="pages/single_page.html" class="media-left"><img alt=""
                                                                                                            src="images/70x70.jpg"></a>
                                    <div class="media-body"><a href="#" class="catg_title">Aliquam malesuada diam eget
                                            turpis varius</a></div>
                                </div>
                            </li>
                            <li>
                ...
                <div class="col-lg-3 col-md-3 col-sm3">
                    <div class="footer_widget wow fadeInRightBig">
                        ...
                        <form action="#" class="subscribe_form">
                            <p id="subscribe-text">We promise, we will only send you awesome stuff which will make your
                                day!</p>
